<template>
    <div 
        ...
        flex gap-4 px-6 py-8 md:px-0 md:py-0 pg-transparent">
        <!-- Search -->
        <div class="relative flex-1 md:min-w-[350px]">
            ...
            <input 
                ...
                v-model="searchQuery"
                @input="search"
                @foucs="$emit('toggleSearchResults')"
            />
            <!-- Search Icon -->
        ...
        <!-- Geolocation -->
        <div 
            class="px-4 pg-white flex items-center shadow-md rounded-md min-h-[45px]" 
